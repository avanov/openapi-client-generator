...
PARAMS_TYPE: Template   = templates.get_template('params_type.py.j2')
REQUEST_TYPE: Template  = templates.get_template('request_type.py.j2')
RESPONSE_TYPE: Template = templates.get_template('response_type.py.j2')
HEADERS_TYPE: Template  = templates.get_template('headers_type.py.j2')
