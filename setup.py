...
setup(name='openapi-client-generator',
      ...
      keywords='utils typing json yaml openapi oas swagger schema serialization deserialization structured-data',
      ...
      entry_points={
          'console_scripts': [
              'openapi-client-generator = openapi_client_generator.cli:main'
          ],
      }
    )
